...
rem location of GNU Arm Embedded Toolchain
set GNU_GCC=C:/gcc-arm-none-eabi-9-2020-q2-update-win32-1/bin

rem Location of xPack Windows Build Tools]
set GNU_TOOLS=C:/xpack-windows-build-tools-2.12.2/bin

rem Location of [SEGGER J-Link Software
